...
public class PickClient extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// INSTANCE DB ADAPTER
		        ...
		        {
		        	Toast.makeText(getApplicationContext(),"No clients found", Toast.LENGTH_LONG).show();
		        	finish();
		        }
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pick_client, menu);
		return true;
	}
